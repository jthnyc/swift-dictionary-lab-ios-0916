 ...
 */
var capital = fiveStates["Florida"]
 ...
 */
var anotherCapital = fiveStates["Pennsylvania"]
...
fiveStates["Pennsylvania"] = "Harrisburg"
 ...
 */
var pennCapital = fiveStates["Pennsylvania"]
if var pennCapital = pennCapital {
 ...
 */
let state = "New York"
var capitalNY = fiveStates[state]
if var capitalNY = capitalNY {
 ...
 */
let bandName = "Pixies"
var pixiesMembers = bands[bandName]
var members = pixiesMembers?.joinWithSeparator(", ")

if var members = members {
    print ("Pixies band members are: \(members)")
}
